...
class ProductionUserDashboard extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _productAvatar(PmOrderListItem o) {
      if (o.productImage != null && o.productImage!.isNotEmpty) {
        // SmartImage expects baseUrl and imageUrl — keep as your component expects
        return ClipRRect(
          borderRadius: BorderRadius.circular(10),
          child: SmartImage(
            imageUrl: o.productImage,
            baseUrl: Constants.apiBaseUrl,
            username: o.productName ?? '',
      ...
      final name = o.productName ?? '';
      final ch = name.isNotEmpty ? name[0].toUpperCase() : '?';
      return CircleAvatar(child: Text(ch));
    }
